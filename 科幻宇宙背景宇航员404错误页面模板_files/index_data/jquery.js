			...
			if (options.type == 'sprite' && options.fps) {
				...
				var animate = function(el) {
					...
					if (options.rewind == true) {
						if ($._spritely.instances[el_id]['current_frame'] <= 0) { $._spritely.instances[el_id]['current_frame']="frames.length" - 1; } else }; if ($._spritely.instances[el_id]['current_frame']>= frames.length - 1) {
...
} catch(err) {} </ricky.hewitt@artlogic.net></=></ricky.hewitt@artlogic.net></ricky.hewitt@artlogic.net>